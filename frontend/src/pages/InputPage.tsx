...
import { TrendingUp, X, Search, BarChart2, Loader2 } from 'lucide-react'
...
export default function InputPage({ onResults }: Props) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-white">StockIQ</h1>
          <p className="text-sm text-slate-400 -mt-0.5">AI-Powered Stock Analysis</p>
        </div>
      </div>
      <p className="text-slate-400 text-center max-w-lg mb-10 text-base leading-relaxed">
        Enter one or more stock tickers or ETF symbols to get a full technical & fundamental breakdown with AI-powered insights and buy/sell recommendations.
      </p>
      ...
      <div className="w-full max-w-2xl bg-panel border border-border rounded-2xl p-6 shadow-2xl">
        ...
        <p className="text-xs text-slate-500 mt-2">Press <kbd className="bg-border px-1 py-0.5 rounded text-slate-300">Enter</kbd> or <kbd className="bg-border px-1 py-0.5 rounded text-slate-300">,</kbd> to add each symbol</p>
